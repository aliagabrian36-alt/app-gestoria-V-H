...
# --- CONFIGURACIÓN DE SUPABASE (Movido arriba para el login) ---
...
# --- SISTEMA DE ACCESO (MODIFICACIÓN SOLICITADA) ---
def login():
    ...
    if not st.session_state.authenticated:
        ...
        with st.form("login_form"):
            ...
            if submit:
                try:
                    # Intento de conexión a Supabase Auth
...
# --- INICIO DE LA APP SI ESTÁ AUTENTICADO ---
if login():
